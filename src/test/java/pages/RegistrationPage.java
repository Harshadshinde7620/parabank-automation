...
public class RegistrationPage {
	...
	private By firstName_loc = By.id("customer.firstName");

	private By lastName_loc = By.id("customer.lastName");

	private By address_loc = By.id("customer.address.street");

	private By city_loc = By.id("customer.address.city");

	private By state_loc = By.id("customer.address.state");

	private By zipcode_loc = By.id("customer.address.zipCode");

	private By phonenumber_loc = By.id("customer.phoneNumber");

	private By ssn_loc = By.id("customer.ssn");

	private By username_loc = By.id("customer.username");

	private By password_loc = By.id("customer.password");

	private By confirm_loc = By.id("repeatedPassword");

	// Buttons
	private By register_btn = By.xpath("//input[@value='Register']");

	// Success Message
	private By success_msg =
